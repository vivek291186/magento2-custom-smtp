...
namespace Emizentech\CustomSmtp\Block\Adminhtml\SystemConfig;
...
class Check extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    */
    ...
    {
        parent::_construct();
        $this->setTemplate('Emizentech_CustomSmtp::systemConfig/check.phtml');
    }
    ...
    public function getTestMailUrl(){
        return $this->_urlInterface->getUrl('emizentechcustomsmtp/check/testmail', array('store' => $this->_request->getParam('store')));
    }
